...
public class ReminderUtilities {
    ...
    private static final int REMINDER_INTERVALS_MINUTES = 1;
    private static final int REMINDER_INTERVALS_SECONDS = (int) (TimeUnit.MINUTES.toSeconds(REMINDER_INTERVALS_MINUTES));
    private static final int SYNC_FLEXTIME_SECONDS = REMINDER_INTERVALS_SECONDS;
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context){
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(
                        ...
                        REMINDER_INTERVALS_SECONDS + SYNC_FLEXTIME_SECONDS))
